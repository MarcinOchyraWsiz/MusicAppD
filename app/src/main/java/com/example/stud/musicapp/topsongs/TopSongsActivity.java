...
public class TopSongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<TrendingList> trendingListCall = ApiService.getService()
                .getTrendingList("us", "itunes", "singles");
        trendingListCall.enqueue(new Callback<TrendingList>() {
            ...
            public void onResponse(Call<TrendingList> call, Response<TrendingList> response) {
                ...
                Toast.makeText(TopSongsActivity.this,
                        "Elementow: " + trendingList.trending.size(),
            ...
            public void onFailure(Call<TrendingList> call, Throwable t) {
                Toast.makeText(TopSongsActivity.this,
                        "Blad pobierania danych: " + t.getLocalizedMessage(),
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
